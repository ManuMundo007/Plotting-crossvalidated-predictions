# -*- coding: utf-8 -*-
"""
Created on Sat Dec 16 00:00:58 2017
...
class ARMAmodels(object):
    ...
    def test_stationarity(self, window, maxlag):
        #https://datascience.ibm.com/exchange/public/entry/view/815137c868b916821dec777bdc23013c
        #Determing rolling statistics
        timeseries = self.ts
        rolmean = timeseries.rolling(window,center=True).mean()
        rolstd = timeseries.rolling(window,center=True).std()
        ...
        dftest = adfuller(timeseries, maxlag)
